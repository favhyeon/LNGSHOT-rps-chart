...
const CUSTOM_COLOR_KEY = "lngshot-custom-colors";
...
const STORAGE_KEY = "lngshot-shotpes-rps";
const LR_STORAGE_KEY = "lngshot-lr-rps";
const LR_CELL_COUNT = 12;

/* 행/열 개별 숨기기 상태 (멤버 인덱스 기준, rows/cols 따로 관리) */
const HIDDEN_KEY = "lngshot-hidden-members";
...
const SELF_PAIR_KEY = "lngshot-include-selfpair";
...
const DESKTOP_CAPTURE_WIDTH = 760;
...
saveBtn.addEventListener("click", async () => {
    ...
    try {
        ...
        const fileLabel = currentTab === "rps" ? "샷페스_취향표" : "공수_취향표";

        const link = document.createElement("a");
        link.href = currentBlobUrl;
        link.download = `LNGSHOT_${fileLabel}.png`;
